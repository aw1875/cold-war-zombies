...
namespace BLAZN.UTILITIES
{
    public class Memory
    {
        ...
        public static IntPtr GetBaseAddress(string ProcessName)
        {
            try
            {
        ...
        public void WriteAByte(ulong _lpBaseAddress, int _Value)
        {
            byte[] bytes = BitConverter.GetBytes(_Value);
            IntPtr zero = IntPtr.Zero;
            WriteProcessMemory(ProcessHandle, _lpBaseAddress, bytes, 1, out zero);
        }
