namespace BigK.Common
{
    public class Offsets
    {
        ...
        //BASES (NEEDS SIGS)//;
        public static ulong PlayerBase = 0x10A96298;
        public static ulong XPScaleBase = 0x10AC6288;
        public static ulong TimeScaleBase = 0xF89D91C;
        public static ulong CMDBufferBase = 0xD81D8D0;
        public static ulong GameSetting = 0x10B95060;
        public static ulong UnlockBase = 0x11D8D180;
        public static ulong ReticleBase = 0x15639830;
        public static ulong SessionState = 0x18D8CA68;
        ...
        public static ulong SkipRoundOne = 0x5F8;
        public static ulong SkipRoundTwo = 0xBF0;
        public static ulong SkipRoundThree = 0x11E8;
        public static ulong SkipRoundFour = 0x17E0;
        public static ulong SkipRoundFive = 0x5F8;
        public static ulong SkipRoundSix = 0x1DD8;

        //PLAYERPEDPTR OFFSETS//
        public static ulong PP_ArraySize_Offset = 0x5F8;
        ...
        public static ulong ZM_Bot_ArraySize_Offset = 0x5E8;

        public static ulong ZM_Bot_Health = 0x390;
